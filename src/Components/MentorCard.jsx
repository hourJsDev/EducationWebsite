  ...
  return (
    <article>
      <div className="mentorCard w-[15rem] overflow-hidden rounded-md transition-all duration-200 ease-out h-[35rem] hover:w-[25rem] relative">
        <h3 className="mentorName absolute top-[.5rem] py-[.2rem] left-[1rem] opacity-0 capitalize rounded-md bg-white px-[1rem] text-[1rem]">{skill}</h3>
        <img
          className="w-full h-full object-cover  transition-all duration-200 ease-out "
          src={image}
          alt={name}
        />
        <div className="absolute flex w-full p-[.5rem] justify-between bottom-0 ">
